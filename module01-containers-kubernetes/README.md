...
- **ما هو Docker؟ وكيف أصبح Kubernetes هو الأداة القياسية لإدارة البنية السحابية الحديثة؟**
 ...
 ### هل هذه الوحدة نظرية فقط؟

نعم، إلى حد كبير. لكنها **ضرورية جدًا** لفهم ما سيأتي لاحقًا.  
مثلما لا يمكن بناء طابقٍ ثانٍ دون أساسٍ متين، كذلك لا يمكن فهم Kubernetes دون إدراك الفكرة من وراء الحاويات وميكروسيرفيسز وDocker.
